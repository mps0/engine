...
rast: main.o drawLine.o vector.o image.o camera.o pipeline.o matrix.o drawTriangle.o assets.o
	$(CXX) $(CFLAGS) -v -o rast main.o $(LFLAGS)

main.o: main.cpp camera.hpp drawLine.hpp image.hpp vector.hpp pipeline.hpp matrix.hpp drawTriangle.hpp assets.hpp
